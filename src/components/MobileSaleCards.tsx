...
export default function MobileSaleCards({ sales, profitFor }: MobileSaleCardsProps) {
  return (
      ...
      {sales.map((s) => (
        <article key={s.id} className="mobile-data-card">
          <div className="mobile-data-card-top">
            ...
            <span className="mobile-data-card-amount">{formatCurrency(s.quantityKg * s.salePricePerKg)}</span>
          </div>
